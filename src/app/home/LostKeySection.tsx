...
export default function LostKeySection() {
    return (
        <section className="flex flex-col lg:flex-row items-center justify-between px-6 lg:px-16 py-12 text-textAll bg-bgAll">
            ...
            <div className="w-full lg:w-1/2 mt-8 lg:mt-0 text-center lg:text-left space-y-6 text-textAll">
